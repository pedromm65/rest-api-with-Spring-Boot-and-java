package br.com.pedrohlimadev.configs;
...
public class TestConfigs {
    ...
    public static final String ORIGIN_VALID_CORS = "http://localhost:8080";
    public static final String ORIGIN_INVALID_CORS = "https://erudio.com";
}
